                    ...
                    <nav id="menu-navigation" class="main-menu">
                        ...
                        <ul class="nav navbar navbar-static-top">
                            ...
                            <li id="menu-1" class="menu-1 logotipo <?php if($module == 'gigs') echo 'active'; ?>"><a href="<?php echo base_url(); ?>">Atezz</a></li>
							 ...
							 <li id="menu-1" class="menu-1 <?php if($module == 'gigs') echo 'active'; ?>"><a href="<?php echo base_url(); ?>">Sobre</a></li> 
							...
							<li id="menu-2" class="menu-2 <?php if($module == 'sell_service') echo 'active'; ?>"><a href="<?php echo base_url().'plano_premium'; ?>">Seja um Profissional </a></li>  
							...
							<li id="menu-7" class="dropdown menu-7 menu-icon-7 <?php if($module == 'password' || $module == 'profile' || $module == 'payment_settings' ) echo 'active'; ?> ">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo base_url().'payment-settings'; ?>">Pagamento</a></li>
								</ul>
							</li>                             
							<li id="menu-8" class="dropdown menu-8 menu-icon-8 <?php if($module == 'purchases' || $module == 'my_gigs' || $module == 'sales' || $module == 'payments' || $module == 'user_profile' ) echo 'active'; ?> ">
								<img style="margin-top: 8px !important;" class="menu-pro-img" src="<?php echo $header_user_image ; ?>" alt="<?php echo $header_user_fullname ; ?>" 
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo base_url().'payments'; ?>">Pagamentos</a></li>
