...
?>	
  ...
  <?php echo $rate_symbol; ?> <input type="text" class="form-control amount numberonly" name="extra_gigs_amount[]" id="label_val_<?php echo $iteration_value; ?>"

   <?php // echo ($allow==1)?'':'readonly'; ?> onfocusout="inputfocusout(this)" value="<?php echo $rate; ?>">
		...
		<span class="currency">for <span class="currency-group">
		 ...
		 <?php echo $rate_symbol; ?><input type="text" class="form-control amount numberonly" id="label_val_1" name="extra_gigs_amount[]"  <?php echo ($allow==1)?'':'readonly'; ?> value="<?php echo $rate; ?>">
			...
			<div class="add-more" <?php if($table_content_row_id>9) { ?>  style="display:none" <?php } ?>>	
                 ...
                 <a href="javascript:;" class="add-more-btn" onclick="add_edit_gig_extra_service();">+ Add more items</a> 
