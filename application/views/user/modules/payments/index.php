            ...
            <div class="container">
                ...
                <div class="row wallet-balance m-b-20">
					...
					<div class="col-md-6 text-right">
						...
						<a href="javascript:;" onclick="withdraw_all();" class="btn btn-primary btn-border text-uppercase bold">Request entire amount</a>
						...
						<div class="modal-body">
							...
							<div class="table-responsive" id="wallets_gigs_details"></div>
							 ...
							 <div id="payment-method">
								...
								<div class="text-center"><a href="#" data-toggle="modal" data-target="#paypal-popup" class="btn btn-primary">Add account details</a></div>
